...
Main.inicializar = function() {
  ...
  if (true) {
    ...
    Blockly.Xml.textToDom('<xml><variables><variable id="[,!UIjKjh|_x;uw)2UY0">hola</variable><variable id="w^^.JQ5.Xs^zyQ(st.jq">chau</variable></variables><block type="main" id="MAIN" x="54" y="115"><statement name="LOOP"><block type="variables_set" id="w!yM2qAm}5RfslIMB3Q/"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field><value name="VALUE"><block type="lists_create_with" id="Sv3p!~MW_uMGei$u}dHm"><mutation items="3"></mutation><value name="ADD0"><block type="procedures_callreturn" id="=Z%^w)]x*S``6~^|iNHr"><mutation name="hola"></mutation></block></value><value name="ADD1"><block type="lists_create_with" id="$t`GtPt$?C/B::-0:aOS"><mutation items="3"></mutation><value name="ADD1"><block type="logic_boolean" id="?A00`*3oiGceO0eoPtge"><field name="BOOL">TRUE</field></block></value></block></value><value name="ADD2"><block type="variables_get" id="Bm-[z#r4l@q{LDaEXNq4"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field></block></value></block></value><next><block type="variables_set" id="}Cq1L[M)k|Zs;yP+jEZR"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="logic_boolean" id="F8[43N7|sBZol{p$6URp"><field name="BOOL">TRUE</field></block></value></block></next></block></statement></block><block type="variables_get" id="_l*L|)I@Pc3]NS60`i]/" x="585" y="156"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field></block><block type="variables_set" id="~Cjy~A`NtWG=z,VVL}LY" x="50" y="341"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="text" id="dWc}`UoM?@PBxWK!mi2R"><field name="TEXT"></field></block></value></block><block type="procedures_defreturn" id="A43=$XHO=C8setE)ZQ9%" x="46" y="398"><field name="NAME">hola</field><comment pinned="false" h="80" w="160">Describe esta función...</comment><statement name="STACK"><block type="variables_set" id=")L7d$-~Q(x/!S:xKw(F("><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="variables_get" id="=e}B%i~UfINs#R4a3)s~"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field></block></value><next><block type="variables_set" id="O5MK5LJe8+~7G.a8PQ;-"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field><value name="VALUE"><block type="procedures_callreturn" id="n{|2L,dwQb1cdBI6yBU,"><mutation name="chau"></mutation></block></value></block></next></block></statement><value name="RETURN"><block type="procedures_callreturn" id="tj`kK8LC!vG,Nf:ZplTx"><mutation name="hola"></mutation></block></value></block><block type="procedures_defreturn" id=")U|(s$CJ(F;[y}PLs1^m" x="40" y="535"><field name="NAME">chau</field><comment pinned="false" h="80" w="160">Describe esta función...</comment><statement name="STACK"><block type="variables_set" id="cYoG|!tc!Z1LThGXVT(C"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="math_number" id="|VCw[J*IkO@qiDs`%aqd"><field name="NUM">5.5</field></block></value><next><block type="variables_set" id="jGTEqXW-vOeB.O:5rVVb"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field><value name="VALUE"><block type="procedures_callreturn" id="W{x@$lTrs@Y1*Etcz}a@"><mutation name="chau"></mutation></block></value></block></next></block></statement><value name="RETURN"><block type="variables_get" id="zZZRZ:+fJt0)Wxo`smIo"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field></block></value></block><block type="variables_set" id="BeE{=d#t[8)Ay_q7h{o+" x="47" y="665"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="logic_boolean" id="$^(kVb@4?Rbw^D[K-0@V"><field name="BOOL">TRUE</field></block></value></block></xml>'),
    Main.workspace);
  } else {
