...
Main.inicializar = function() {
  ...
  if (false) {
    ...
    Blockly.Xml.textToDom('<xml><variables><variable id="or(Q;=|s{/2^#++KP]d8">x</variable><variable id="%j!Ik%!rO,[@}Xg;{Y/~">y</variable><variable id="l-;Z6W@;DMzN5BN|N.Y.">hola</variable></variables><block type="main" id="MAIN" x="50" y="50"></block><block type="procedures_defnoreturn" id="Xt7V{lS|vOwh*H^{Qv!v" x="429" y="124"><mutation><arg name="x" varid="or(Q;=|s{/2^#++KP]d8"></arg><arg name="y" varid="%j!Ik%!rO,[@}Xg;{Y/~"></arg></mutation><field name="NAME">hola</field><comment pinned="false" h="80" w="160">Describe esta función...</comment><statement name="STACK"><block type="variables_set" id="}GEet7Q35/!$`=h~m%T="><field name="VAR" id="or(Q;=|s{/2^#++KP]d8">x</field><value name="VALUE"><block type="math_number" id="xn]XMw0zMwVf85=ELcM|"><field name="NUM">123</field></block></value><next><block type="variables_set" id="X*H1W(/LXai4:*BH65B]"><field name="VAR" id="l-;Z6W@;DMzN5BN|N.Y.">hola</field></block></next></block></statement></block><block type="procedures_defnoreturn" id="BHr`nq3c2rMb6hu0uT)V" x="50" y="188"><mutation><arg name="x" varid="or(Q;=|s{/2^#++KP]d8"></arg><arg name="y" varid="%j!Ik%!rO,[@}Xg;{Y/~"></arg></mutation><field name="NAME">chau</field><comment pinned="false" h="80" w="160">Describe esta función...</comment><statement name="STACK"><block type="procedures_callnoreturn" id="qRa{|[gI#Bs3,*u.~yEy"><mutation name="hola"><arg name="x"></arg><arg name="y"></arg></mutation><value name="ARG0"><block type="logic_boolean" id="jh1y|}lQ/pg%v_B,35gX"><field name="BOOL">TRUE</field></block></value><next><block type="procedures_callnoreturn" id="0dyne^id.D**(Gg`H7V!"><mutation name="hola"><arg name="x"></arg><arg name="y"></arg></mutation><value name="ARG0"><block type="math_number" id="C:cF;ae%Lamg@W$vEImS"><field name="NUM">123</field></block></value><next><block type="procedures_callnoreturn" id="5xo*n_e,TY76W/uTNR_b"><mutation name="hola"><arg name="x"></arg><arg name="y"></arg></mutation><value name="ARG0"><block type="logic_boolean" id="aTEXOc{B0=8mEf0i(49w"><field name="BOOL">TRUE</field></block></value><next><block type="procedures_callnoreturn" id="ub,r;7r(=r+xYFP0%l96"><mutation name="hola"><arg name="x"></arg><arg name="y"></arg></mutation><value name="ARG0"><block type="text" id="r39Qj-+hy@(4Q}lizAX3"><field name="TEXT"></field></block></value><next><block type="variables_set" id="`|c_$%/5u{nMcQo[~|j7"><field name="VAR" id="or(Q;=|s{/2^#++KP]d8">x</field></block></next></block></next></block></next></block></next></block></statement></block><block type="variables_set" id="nR,+Az;RsneJYFmX6_yx" x="418" y="250"><field name="VAR" id="or(Q;=|s{/2^#++KP]d8">x</field><value name="VALUE"><block type="logic_boolean" id="kAR1GJtL?yA*2_2uP-P:"><field name="BOOL">TRUE</field></block></value></block><block type="math_number" id="nm6GZ`!phiU80nKF.*U0" x="559" y="362"><field name="NUM">123</field></block><block type="logic_boolean" id="3YJ6B#oG!Ec2w?_LlgEO" x="255" y="443"><field name="BOOL">TRUE</field></block></xml>'),
    Main.workspace);
  } else {
