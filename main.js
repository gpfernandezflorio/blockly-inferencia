...
Main.inicializar = function() {
  ...
  if (true) {
    ...
    Blockly.Xml.textToDom('<xml><variables><variable id="[,!UIjKjh|_x;uw)2UY0">hola</variable><variable id="w^^.JQ5.Xs^zyQ(st.jq">chau</variable></variables><block type="main" id="MAIN" x="58" y="81"><statement name="LOOP"><block type="controls_if" id=")3;1bCDi[dW?1N:7vS,Y"><statement name="DO0"><block type="variables_set" id="mQ-}E$m=n?bL{cPJEc:_"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="logic_boolean" id="D836/#4LO[M*IKWtePs}"><field name="BOOL">TRUE</field></block></value><next><block type="variables_set" id="+aC?W(+s2AU}Eho_/`JR"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="math_number" id="^/.C0goZG4c.i9B8w(Vz"><field name="NUM">123</field></block></value><next><block type="variables_set" id="w!yM2qAm}5RfslIMB3Q/"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field><value name="VALUE"><block type="variables_get" id="Iu7;ao)#zv`USP$4d;8B"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field></block></value></block></next></block></next></block></statement><next><block type="controls_repeat_ext" id="z_D7Tgls)rQyAU(+uVWW"><value name="TIMES"><shadow type="math_number" id="Jfx)fP[Lu;5AZvq*D6R:"><field name="NUM">10</field></shadow></value><statement name="DO"><block type="controls_if" id="tO(DAllCHQ|UF6F_ik[Y"><value name="IF0"><block type="variables_get" id="_sP=RkBV.o%g%]5o^7g_"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field></block></value><statement name="DO0"><block type="variables_set" id="~Cjy~A`NtWG=z,VVL}LY"><field name="VAR" id="[,!UIjKjh|_x;uw)2UY0">hola</field><value name="VALUE"><block type="variables_get" id="}6K=h:LXs$LA(,mtx}6g"><field name="VAR" id="w^^.JQ5.Xs^zyQ(st.jq">chau</field></block></value></block></statement></block></statement></block></next></block></statement></block></xml>'),
    Main.workspace);
  } else {
